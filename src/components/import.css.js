...
.imp-step.done{background:#EAF0FF;border-color:#CFDBFF;color:#1338DE}
...
.imp-bar i{display:block;height:100%;background:#1338DE;border-radius:999px;transition:width .12s linear}
.imp-count{font-family:'Space Grotesk',sans-serif;font-size:30px;font-weight:600;color:#1338DE;margin-top:14px}
